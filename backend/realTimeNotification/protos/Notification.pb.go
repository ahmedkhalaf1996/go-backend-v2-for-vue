...
type NotificationGrpcRequest struct {
	...
	Deatils       string                 `protobuf:"bytes,2,opt,name=deatils,proto3" json:"deatils,omitempty"`
	...
	Isreded       bool                   `protobuf:"varint,5,opt,name=isreded,proto3" json:"isreded,omitempty"`
...
func (x *NotificationGrpcRequest) GetDeatils() string {
	if x != nil {
		return x.Deatils
	}
	return ""
...
func (x *NotificationGrpcRequest) GetIsreded() bool {
	if x != nil {
		return x.Isreded
	}
	return false
...
const file_protos_Notification_proto_rawDesc = "" +
	"\n" +
	"\x19protos/Notification.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xed\x01\n" +
	"\x17NotificationGrpcRequest\x12\x0f\n" +
	"\x03_id\x18\x01 \x01(\tR\x02Id\x12\x18\n" +
	"\adeatils\x18\x02 \x01(\tR\adeatils\x12\x18\n" +
	"\amainuid\x18\x03 \x01(\tR\amainuid\x12\x1a\n" +
	"\btargetid\x18\x04 \x01(\tR\btargetid\x12\x18\n" +
	"\aisreded\x18\x05 \x01(\bR\aisreded\x128\n" +
